...
.hrv-discount-choose-coupons #list_short_coupon {display: -webkit-flex; display: flex; flex-wrap: wrap; justify-content: flex-end;}
.hrv-discount-choose-coupons > div:first-child { flex: 0 0 134px; }
...
<input id="reloadValue" type="hidden" name="reloadValue" value="" />
			...
			<div class="banner">
				<div class="wrap">
					<a href="/" class="logo">
							...
							<h1 class="logo-text">Mac store Hải Phòng</h1>
			...
			<button class="order-summary-toggle order-summary-toggle-hide">
				<div class="wrap">
					<div class="order-summary-toggle-inner">
						...
						<div class="order-summary-toggle-total-recap" data-checkout-payment-due-target="5798000000">
							<span class="total-recap-final-price">57,980,000₫</span>
						</div>
					</div>
				</div>
			</button>
			...
			<div class="content">
				<div class="wrap">
					<div class="row">
                    <div class="main col-md-6 col-12 p-4">
												...
												<div class="section">
													...
													<div class="section-content section-customer-information no-mb">
															...
															<p class="section-content-text">
																Bạn đã có tài khoản?
																<a href="/account/login?urlredirect=%2Fcheckouts%2Fba8b3d3961a341cdbcb52c66222482a9%3Fstep%3D1">Đăng nhập</a>
															</p>
						...
						<div class="sidebar p-4 col-md-6 col-12">
							<div class="sidebar-content">
										...
										<div class="order-summary-section order-summary-section-product-list" data-order-summary-section="line-items">
											<table class="product-table">
												...
												<tbody>
														...
														<tr class="product" data-product-id="1037739909" data-variant-id="1082488495">
															<td class="product-image">
																<div class="product-thumbnail">
																	<div class="product-thumbnail-wrapper">
																		<img class="product-thumbnail-image" alt="iPhone 13 Pro Max" src="//product.hstatic.net/200000458129/product/upload_8425d5c4310a4532a894d46f6fe76a2a_small.jpg" />
																	</div>
																	<span class="product-thumbnail-quantity" aria-hidden="true">2</span>
																</div>
															</td>
															<td class="product-description">
																<span class="product-description-name order-summary-emphasis">iPhone 13 Pro Max</span>
															...
															<td class="product-price">
																<span class="order-summary-emphasis">57,980,000₫</span>
															</td>
														</tr>
												...
												<tbody>
													<tr class="total-line total-line-subtotal">
														...
														<td class="total-line-price">
															<span class="order-summary-emphasis" data-checkout-subtotal-price-target="5798000000">
																57,980,000₫
															</span>
														</td>
													</tr>
												...
												<tfoot class="total-line-table-footer">
													<tr class="total-line">
														...
														<td class="total-line-name payment-due">
															...
															<span class="payment-due-price" data-checkout-payment-due-target="5798000000">
																57,980,000₫
															</span>
