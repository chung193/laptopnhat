...
<ul class="navigation list-group list-group-flush scroll">
	...
	<?php 
		...
		<h1 class="d-none">EGA Techstore - </h1>
...
<ul class="navigation list-group list-group-flush scroll">
		...
		<li class="menu-item list-group-item">
		<a href="#" class="menu-item__link" title="Tổng hợp khuyến mãi">
				<img width="24" height="24" src="<?= base_url()?>public/techstore/EGA Techstore_files/menu_icon_1.png" alt="Tổng hợp khuyến mãi">
				<span>Tổng hợp khuyến mãi</span>
		</a>			
		...
		?>
			<li class="menu-item list-group-item">
				<a href="<?= base_url()?>san-pham/<?= $val['link']?>" class="menu-item__link" title="<?= $val['name']?>">
			...
			?>
				<li class="submenu__col">
					<span class="submenu__item submenu__item--main">
						<a class="link" href="<?= base_url()?>san-pham/<?= $value['link']?>" title="<?= $value['name']?>"><?= $value['name']?></a>
					</span>
					<?php 
					...
					?>
						<span class="submenu__item submenu__item">
							<a class="link" href="<?= base_url()?>san-pham/<?= $x['link']?>" title="<?= $x['name']?>"><?= $x['name']?></a>
						</span>
					<?php }} ?>	
				</li>
			<?php } ?>
...
<div class="col-xl-9 col-12 home-banner-group pl-xl-0">
	...
	<div class="home-slider__dot-fake desktop" style="display: none;">
	...
	<div class="home-slider__dot-fake mobile" style="display: none;">
				<div class="home-slider__dot-fake__item active">
...
<!-- <section class="section awe-section-2">	
	...
	<div class="container border-0">
				<div class="mt-2 text-center row flex-nowrap collections-slide slick-initialized slick-slider">

			<div aria-live="polite" class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 1200px; transform: translate3d(0px, 0px, 0px);" role="listbox"><div class="item   slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" style="width: 120px;" tabindex="-1" role="option" aria-describedby="slick-slide30">
				
				<a href="<?= base_url() ?>collections/all" title="Nổi bật" class="pos-relative d-flex align-items-center " style="aspect-ratio:100/ 100" tabindex="0"> 
					<img class="img-fluid m-auto object-contain mh-100" src="<?= base_url()?>public/techstore/EGA Techstore_files/coll_1.jpg" width="100" height="100" alt="coll_1_title">
				</a>
				<h3 class="mb-0">
					<a href="<?= base_url() ?>collections/all" title="Nổi bật" tabindex="0">
						Nổi bật		
					</a>
				</h3>
			</div>
			...
			<?php 
				...
				foreach($category as $val){
			?>
			<div class="item  slick-slide slick-active" data-slick-index="1" aria-hidden="false" style="width: 120px;" tabindex="-1" role="option" aria-describedby="slick-slide31">
				<a href="<?= $val['link']?>" title="Điện thoại " class="pos-relative d-flex align-items-center " style="aspect-ratio:100/ 100" tabindex="0"> 
					<img class="img-fluid m-auto object-contain mh-100" src="<?= base_url()?>public/images/category/<?= $val['img']?>" width="100" height="100" alt="coll_2_title">
				</a>
				<h3 class="mb-0">
					<a href="<?= $val['link']?>" title="<?= $val['name']?>" tabindex="0">
							<?= $val['name']?>	
					</a>
				</h3>
			</div>
...
<section class="section awe-section-3">	
	<link rel="preload" as="style" type="text/css" href=".<?= base_url()?>public/techstore/EGA Techstore_files/coupon.css">

<link rel="stylesheet" href=".<?= base_url()?>public/techstore/EGA Techstore_files/coupon.css">
<!-- ℹ-->
