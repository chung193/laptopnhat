<html lang="">
    ...
    <body>
        <div class="container khung">
            <div class="title">
                <h2 class="text-center" style="color:#8ac400">Macstore Hải Phòng</h2>
            </div>
            <hr>
            <div class="myform">
        ...
        <nav class="navbar navbar-fixed-bottom" role="navigation">
            <div class="container">
               <h5 class="text-center">Copyright © 2017 <a href="https://www.facebook.com/trungphatit" style="color:red">PYWeb</a>. All rights reserved.</h5>
            </div>
        </nav>
        <!-- jQuery -->
