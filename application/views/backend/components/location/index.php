...
<div class="content-wrapper">
	<section class="content-header">
		...
		<div class="breadcrumb">
			<a class="btn btn-primary btn-sm" href="<?php echo base_url()?>admin/location/insert" role="button">
			...
			<!-- <a class="btn btn-primary btn-sm" href="admin/category/recyclebin" role="button">
				...
				(<?php 
				// $total=$this->Mcategory->category_trash_count(); echo $total; 
				?>)
			</a> -->
		</div>
	</section>
								...
								<table class="table table-hover table-bordered">
									<thead>
										<tr>
											...
											<th>Địa chỉ</th>
											<th class="text-center" style="width:150px">Điện thoại</th>
									...
									<?php foreach ($list as $val):?>
										<tr>
											...
											<td>
												<a href="<?php echo base_url() ?>admin/location/update/<?php echo $val['id'] ?>"><?php echo $val['location'] ?></a>	
											</td>
											<td>
												<?php echo $val['phone'] ?>
											</td>
											...
											<td class="text-center">
												<a class="btn btn-success btn-xs" href="<?php echo base_url() ?>admin/location/update/<?php echo $val['id'] ?>" role = "button">
													<span class="glyphicon glyphicon-edit"></span>Sửa
												</a>
											</td>
											<td class="text-center">
												<a class="btn btn-danger btn-xs" href="<?php echo base_url() ?>admin/location/delete/<?php echo $val['id'] ?>" role = "button">
