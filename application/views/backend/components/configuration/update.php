					...
					<div class="box" id="view">
						<div class="box-body">
							...
							<?php echo validation_errors(); ?>
								...
								<div class="form-group">
									<label> Tổng đài chăm sóc khách hàng <span class = "maudo">(*)</span></label>
									<input type="text" class="form-control" name="phone_for_take_care" style="width:100%" placeholder="phone for take care" value="<?php echo $row['phone_for_take_care'] ?>">
								</div>

								<div class="form-group">
									<label> Tổng đài mua hàng <span class = "maudo">(*)</span></label>
									<input type="text" class="form-control" name="phone_for_sale" style="width:100%" placeholder=" phone for sale" value="<?php echo $row['phone_for_sale'] ?>">
								</div>
 
								<div class="form-group">
									<label> Tổng đài bảo hành <span class = "maudo">(*)</span></label>
									<input type="text" class="form-control" name="phone_for_insurance" style="width:100%" placeholder="phone for insurance" value="<?php echo $row['phone_for_insurance'] ?>">
								</div>

								<div class="form-group">
                                    <label>Giờ làm việc</label>
									<input type="text" class="form-control" name="timework" style="width:100%" placeholder="Giờ làm việc" value="<?php echo $row['timework'] ?>">
                                </div>
								...
								<img src="<?= base_url()?>public/images/logo/<?= $row['logo']?>" width="300" >
