<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                <a href="<?php echo base_url()?>admin/pagetype">
                    <i class="fa fa-indent"></i><span>Loại trang</span>
                </a>
            </li>
            <li class="treeview">
            ...
            <li >
                <a href="<?php echo base_url() ?>admin/page">
                    <i class="glyphicon glyphicon-list"></i> Trang
                </a>
            </li>
            <li>
            ...
            <li class="treeview">
                <a href="<?php echo base_url() ?>admin/location">
                    <i class="fa fa-globe"></i><span>Địa chỉ công ty</span>
                </a>
            </li>
