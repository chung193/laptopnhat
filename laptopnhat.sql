...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 24, 2022 lúc 03:49 PM
...
--
-- Cấu trúc bảng cho bảng `db_content_type`
--
...
--
-- Đang đổ dữ liệu cho bảng `db_content_type`
--
...
--
-- Cấu trúc bảng cho bảng `db_location`
--
...
--
-- Đang đổ dữ liệu cho bảng `db_location`
--
...
--
-- Cấu trúc bảng cho bảng `db_page`
--
...
--
-- Đang đổ dữ liệu cho bảng `db_page`
--
...
--
-- Cấu trúc bảng cho bảng `db_page_type`
--
...
--
-- Đang đổ dữ liệu cho bảng `db_page_type`
--
...
--
-- Đang đổ dữ liệu cho bảng `db_product_instance`
--
...
--
-- Cấu trúc bảng cho bảng `db_product_option`
--
...
--
-- Cấu trúc bảng cho bảng `db_social`
--
...
--
-- Đang đổ dữ liệu cho bảng `db_social`
--
...
--
-- Cấu trúc bảng cho bảng `db_submail`
--
...
--
-- Chỉ mục cho bảng `db_content_type`
--
...
--
-- Chỉ mục cho bảng `db_page`
--
ALTER TABLE `db_page`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `db_page_type`
--
...
--
-- Chỉ mục cho bảng `db_product_instance`
--
ALTER TABLE `db_product_instance`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `db_product_option`
--
...
--
-- Chỉ mục cho bảng `db_social`
--
ALTER TABLE `db_social`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `db_submail`
--
...
--
-- AUTO_INCREMENT cho bảng `db_content_type`
--
ALTER TABLE `db_content_type`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT cho bảng `db_social`
--
ALTER TABLE `db_social`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `db_submail`
--
ALTER TABLE `db_submail`
